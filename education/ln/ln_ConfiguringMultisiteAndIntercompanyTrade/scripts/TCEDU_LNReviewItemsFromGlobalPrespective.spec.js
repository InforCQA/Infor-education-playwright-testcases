...
const itemCnxt = JSON.parse(JSON.stringify(require("../data/ReviewItemsFromGlobalPrespective.properties.json")));
/** ---------------------------------------------------------------------------------------
...
export default function TCEDU_LNReviewItemsFromGlobalPrespective() {
    ...
    describeTest('TCEDU_LNReviewItemsFromGlobalPrespective', () => {
