...
const itemsBySiteCnxt = JSON.parse(JSON.stringify(require("../data/ReviewAndUpdateItemsFromSalesPerspective.properties.json")));
/**---------------------------------------------------------------------------------------
...
export default function TCEDU_LNReviewAndUpdateItemsFromSalesPerspective() {
    ...
    describeTest('TCEDU_LNReviewAndUpdateItemsFromSalesPerspective', () => {
