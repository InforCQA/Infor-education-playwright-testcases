...
import GetDataLN_DevelopTheOriginalEnterpriseStructure from '../dataMapping/GetDataLN_DevelopTheOriginalEnterpriseStructure';
...
const structureCnxt = JSON.parse(JSON.stringify(require("../data/DevelopTheOriginalEnterpriseStructure.properties.json")));
...
export default function TCEDU_LNDevelopTheOriginalEnterpriseStructure() {
    ...
    describeTest('TCEDU_LNDevelopTheOriginalEnterpriseStructure', () => {
