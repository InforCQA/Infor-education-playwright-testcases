...
const warehouseCnxt = JSON.parse(JSON.stringify(require("../data/CreateAWarehouseTransferAndPurchaseOrder.properties.json")));
...
export default function TCEDU_LNCreateAWarehouseTransferAndPurchaseOrder() {
    ...
    describeTest('TCEDU_LNCreateAWarehouseTransferAndPurchaseOrder', () => {
    ...
    //     });
        ...
        //     warehouseCnxt.intercompanyTradeNumSales="000000075";
