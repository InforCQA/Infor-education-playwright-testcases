...
class LNPage extends BaseClass{
    ...
    lnFrame = async() =>{ return await this.page.frameLocator("//iframe[contains(@name,'LN_')]").frameLocator("//iframe[contains(@id,'workbench-frame')]")};
    ...
    /* hiddenCheckbox */
    hiddenCheckbox = async() =>{
        return await (await this.lnFrame()).locator(`//div[contains(@class,'Checkbox')][contains(@id,'hidden')]`)};

    /* personalizationSave */
    personalizationSave = async() =>{
        return await (await this.lnFrame()).locator(`//div[contains(@id,'button-SAVE_AND_CLOSE')]`)};
    ...
    /* allFilter - label */
    allFilter = async() =>{
        return await (await this.lnFrame()).locator(`(//div[contains(@class,'FramedWindow') and not(@aria-hidden='true')]//input[contains(@id,'All-name-filter')])[last()]`)};

    /* allTab - Tab */
    allTab = async() =>{
        return await (await this.lnFrame()).locator(`(//label[text()='All'][not(contains(@id,'field'))]/ancestor::div[@class='Tab'])[last()]`)};

    /* allCheckBox - label */
    allCheckBox = async() =>{
        return await (await this.lnFrame()).locator(`(//div[contains(@id,'All-header-n0')])[last()]`)};
    ...
    personalizationOptions = async(p1, p2) =>{
        return await (await this.iframe()).locator(`//label[contains(@id,'${p1}')][normalize-space()='${p2}']`)};
