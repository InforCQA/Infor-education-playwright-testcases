...
import EnterpriseModelWorkbenchPage from "../../ConfiguringMultisiteAndIntercompanyTrade/pages/EnterpriseModelWorkbenchPage";
...
import LNPage from "../../ConfiguringMultisiteAndIntercompanyTrade/pages/LNPage";
...
static async reviewNewSiteDetailsInEnterpriseModelWorkbench(structureCnxt) {
    ...
    static async reviewItemDefaults(itemCnxt) {
        ...
        console.log("=========>>>>> Review item defaults started <<<<<=========");
    ...
    static async createANewItem(itemCnxt) {
		...
		console.log("=========>>>>> Create a new item started <<<<<=========");
		...
		console.log("=========>>>>> Create a new item completed sucessfully <<<<<=========");
	}
